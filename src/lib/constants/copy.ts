...
export const copy = {
  ...
  trivia: {
    ...
    leaveConfirmTitle: "Leave this round?",
    leaveConfirmDescription:
      "The question you're on will be saved as incorrect answer. You can resume rest of the questions later.",
    ...
    dailyResumeHeading: "Unfinished round",
    dailyResumeTagline: "You answered {answered} of {total} — continue?",
